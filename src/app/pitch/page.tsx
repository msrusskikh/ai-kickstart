...
const pitchSlides = [
  ...
  },
  {
    id: 5,
    title: "Результат",
    content: "Сотрудники, не пользовавшиеся ИИ, массово начинают автоматизировать часть своих задач и становятся продуктивнее"
  },
  {
    id: 6,
    title: "Экономика",
