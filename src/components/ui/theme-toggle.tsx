  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button variant="outline" size="icon" className="hover:bg-accent/50 transition-all duration-200">
      ...
      <DropdownMenuContent align="end" className="w-32">
        ...
        <DropdownMenuItem onClick={() => setTheme("system")} className="cursor-pointer transition-colors duration-150">
          System
        </DropdownMenuItem>
      </DropdownMenuContent>
    </DropdownMenu>
